...
def _user_prompt(*, document_type: str, content_format: str, skill: dict[str, Any], context: dict[str, Any], template: dict[str, Any]) -> str:
    ...
    payload = {
        ...
        "conversation_evidence": {
            ...
            "active_conversation_decisions": context.get("active_conversation_decisions") or [],
            ...
            "hard_rules": [
                "active_conversation_decisions are the highest-priority evidence for this draft.",
                "Write the body according to active conversation decisions before source defaults.",
                "weak_conversation_references may appear only as uncertainty, note, risk, or pending confirmation; never promote them to confirmed facts.",
                "If conversation conclusions conflict with source text, follow the conversation conclusion in the body and leave a conflict trace.",
                "Do not leak internal evidence ids, candidate ids, session memory ids, or message ids in user-visible content.",
            ],
        },
    ...
    *,
    ...
    payload = {
        ...
        "conversation_evidence": {
            ...
            "hard_rules": [
                "active_conversation_decisions are the highest-priority evidence for this draft.",
                "Preserve already-applied conversation conclusions unless the latest same-topic decision supersedes them.",
                "weak_conversation_references may appear only as uncertainty, note, risk, or pending confirmation; never promote them to confirmed facts.",
                "If conversation conclusions conflict with source text, follow the conversation conclusion in the body and leave a conflict trace.",
                "Do not leak internal evidence ids, candidate ids, session memory ids, or message ids in user-visible content.",
            ],
